// CoolMath and Poki embeds ship with no account system at all: the navbar login
// button is hidden, OAuth can't escape their iframe anyway, and both partners
// forbid funnelling players to an off-platform signup.
//
