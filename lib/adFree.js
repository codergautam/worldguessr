 ...
 *
 *  IT HAS TO EXPIRE BY ITSELF. A pass is 20 minutes, and a boolean derived from
 *  Date.now() only re-evaluates when something else happens to re-render. The
 *  hook therefore arms ONE setTimeout for exactly the remaining milliseconds
 *  and flips back when it fires. Not an interval: there is exactly one moment
 *  in the future when this answer changes and it is known in advance, so polling
 *  for it every second would be work spent to learn nothing 1,199 times out of
 *  1,200.
 * ======================================================================== */
 ...
 * anything holding that boolean must not re-render 1,200 times to learn nothing.
