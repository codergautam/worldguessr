...
const IGNORED = [
  ...
  '_leaflet_pos',
  // NitroPay's filters ('NitroAds', scalibur's container noise) retired with
  // the Playwire swap (Aug 2). Expect Playwire to bring its own unmount-race
  // noise — add its signatures here when GA exception events surface them.
