...
const IGNORED = [
  ...
  '_leaflet_pos',
  // NitroPay filters retired with the Playwire swap (Aug 2). Expect Playwire
  // to bring its own unmount-race noise — add its signatures here when the
  // GA exception events surface them.
  // 'NitroAds',
