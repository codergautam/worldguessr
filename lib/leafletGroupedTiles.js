...
if (!L.GridLayer.prototype._groupedTiles) {
  ...
  // Leaflet 1.9.4's CSS applies `mix-blend-mode: plus-lighter` as a Chromium
  // seam workaround. During a fractional pinch/crossfade that additive blend
  // brightens independently anti-aliased tile edges into the WHITE lines seen
  // on Android WebView (and turns real overlap into white blocks). Keep exact
  // 256px geometry and normal source-over compositing for grouped rasters.
  // This is creation-time only; it adds no work to zoom frames.
