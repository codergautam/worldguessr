 ...
 *
 * The pin ART is authored at 87x131, but the PNG canvas is 151x163: 32px of
 * transparent headroom on the top and both sides, NONE on the bottom. That
 ...
 * bottom-centre and a padded pin lands on its latlng exactly like the old
 * edge-to-edge pins did. The headroom exists so pin art can carry a glow —
 * on the old canvas any glow was sheared flat at the image border.
 *
 ...
 * constants. Change GLOW_PAD only in lockstep with re-exporting every PNG
 * (public/dest|src|src2.png, public/pins/*, mobile/assets/pins/*) — the
...
export const PIN_PATHS = [
   ...
   * They are authored on the stock pins' exact canvas (the 151x163 spec above:
