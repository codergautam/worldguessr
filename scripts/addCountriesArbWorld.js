...
if (isMainThread) {
  // ===== MAIN THREAD =====
  const arbitraryWorld = JSON.parse(fs.readFileSync('./data/world-arbitrary.json', 'utf8'));
  ...
  // Write back
  fs.writeFileSync('./data/world-arbitrary.json', JSON.stringify(arbitraryWorld));
  console.log('Saved to ./data/world-arbitrary.json');
