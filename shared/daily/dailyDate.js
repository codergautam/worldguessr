// Pure date / challenge-number helpers for the Daily Challenge.
// Shared verbatim by the web app (Next.js) and the mobile app (Expo) — no
// platform APIs, no storage. Edit here only; both apps re-export this module.
